...
<section>
   ...
   <button type="button" id="matricula" class="bolhaG" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal-matricula">Matrícula</button>
 ...
 <button type="button" id="trancamento" class="bolhaP" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal1">Trancamento</button>
  <div class="modal fade" id="myModal1" role="dialog">
   ...
   <button type="button" id="transferencia" class="bolhaP" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2">Transferência</button>
  <div class="modal fade" id="myModal2" role="dialog">
    <div class="modal-dialog">
     <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Transferência de Estudantes</h4>
        </div>
        <div class="modal-body">
          <p> O IFPE expedirá a transferência  do estudante para outras instituições de ensino,mediante requerimento,em qualquer época do ano .A solicitação de               transfrência deverá ser feita pelo estudante  maior de idade  ou pelo representante  legal do estudante menor de idade.</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Fechar</button>
        </div>
...
<button type="button" id="frequencia" class="bolhaG" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal7">Frequência</button>
 <button type="button" id="faltas" class="bolhaP" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4">Faltas</button>
  <div class="modal fade" id="myModal4" role="dialog">
    <div class="modal-dialog">
     <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" data-target="#trancamento">&times;</button>
          <h4 class="modal-title"> Da Ausência Justificada</h4>
        </div>
        <div class="modal-body">
  ...
  <button type="button" id="avaliacoes" class="bolhaG" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal6">Avaliações</button>
  <div class="modal fade" id="myModal6" role="dialog">
    <div class="modal-dialog">
     <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Exames Finais</h4>
        </div>
        <div class="modal-body">
...
<button type="button" id="notas" class="bolhaP" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal5">Aprovação</button>
...
<button type="button" id="duvidas" class="bolhaG" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal8">Dúvidas</button>
